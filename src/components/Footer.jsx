            ...
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
                ...
                <div>
                    ...
                    <ul style={{ listStyle: 'none', color: 'var(--color-text-secondary)', display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1.5rem' }}>
                        <li>No. 289,Waikiki complex,door no. 26,Purasawakkam high road, 7, next to BUHARI Restaurant / Take Away / Party Hall, Purasaiwakkam, Chennai, Tamil Nadu 600007<br /><span style={{ fontSize: '0.9rem', color: 'var(--color-gold)', marginTop: '0.5rem', display: 'inline-block' }}>Landmark: next to BUHARI Restaurant</span></li>
