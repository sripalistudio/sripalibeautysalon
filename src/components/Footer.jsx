...
const Footer = () => {
    return (
        <footer style={{ background: '#0a0a0a', padding: '4rem 0 2rem', borderTop: '1px solid rgba(212, 175, 55, 0.1)' }}>
            <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '3rem' }}>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                            <a href="https://www.instagram.com/sripalibridalmakeupartist?igsh=OWk5Ynk2NGxlZjdz" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-gold)' }}><Instagram size={20} /></a>
                            <a href="https://wa.me/919841428097" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-gold)' }}>
                ...
                <div>
                    ...
                    <ul style={{ listStyle: 'none', color: 'var(--color-text-secondary)', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                        <li>
                            <a href="https://sripalibridalstudio.in/" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit' }}>
                                Sripali Bridal Studio
                            </a>
                        </li>
                        <li>
                    ...
                    <ul style={{ listStyle: 'none', color: 'var(--color-text-secondary)', display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1.5rem' }}>
                        <li>
                            <a href="https://maps.app.goo.gl/zku9SHip5iYZXwda8" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none' }}>
                                No. 289,Waikiki complex,door no. 26,Purasawakkam high road, 7, next to BUHARI Restaurant / Take Away / Party Hall, Purasaiwakkam, Chennai, Tamil Nadu 600007<br /><span style={{ fontSize: '0.9rem', color: 'var(--color-gold)', marginTop: '0.5rem', display: 'inline-block' }}>Landmark: next to BUHARI Restaurant</span>
                            </a>
                        </li>
                        <li><a href="mailto:sripally@yahoo.com" style={{ color: 'inherit' }}>sripally@yahoo.com</a></li>
                        <li><a href="tel:+919841428097" style={{ color: 'inherit' }}>+91 98414 28097</a></li>
                        <li><a href="tel:04445028097" style={{ color: 'inherit' }}>044-45028097</a></li>
                    </ul>
            ...
            <div className="container" style={{
                ...
                <p>&copy; 2026 Sripali Beauty Salon. All rights reserved.</p>
                <p>
