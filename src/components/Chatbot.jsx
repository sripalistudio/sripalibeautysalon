...
const Chatbot = () => {
    ...
    const [messages, setMessages] = useState([
        { type: 'bot', text: "Welcome to Sripali Beauty Salon. How can I assist you today?" }
    ]);
            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                        ...
                        `}</style>
                        {/* Header */}
                        <div style={{ padding: '1rem', background: '#000000', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                        ...
                        {/* Quick Actions */}
                        <div style={{ padding: '1rem', background: '#000000', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
