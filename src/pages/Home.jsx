...
const Home = () => {
    ...
    return (
        ...
        >
            <SEO
                title="Sripali Beauty Salon | Luxury Bridal Makeup Artist in Chennai"
                description="Sripali Beauty Salon offers premium bridal makeup, hair styling, and saree draping services in Chennai. Book your consultation for a flawless wedding look."
            />
            {/* Hero Section */}
            <section
                style={{
            ...
            <section className="section-padding" style={{ background: '#000000' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        ...
                        <motion.div
                            whileHover={{ y: -5 }}
                            style={{ background: '#111111', padding: '2.5rem', borderRadius: '12px', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}
                        >
                            <div style={{ background: 'rgba(212, 175, 55, 0.1)', width: '60px', height: '60px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
            ...
            <section className="section-padding" style={{ background: '#111111' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginBottom: '3rem' }}>
                        ...
                        <motion.div
                            whileHover={{ y: -5 }}
                            style={{ background: '#000000', padding: '2.5rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}
                        >
            ...
            <section className="section-padding" style={{ background: '#000000' }}>
                <div className="container">
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        ...
                        <motion.div
                            whileHover={{ y: -10 }}
                            style={{ background: '#0A0A0A', borderRadius: '8px', overflow: 'hidden', textAlign: 'center', paddingBottom: '2rem' }}
                        >
