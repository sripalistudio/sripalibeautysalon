  ...
  return (
    ...
    >
      <SEO
        ...
        description="Explore our gallery of real brides. See transformations, HD makeup, and hair styling by Sripali Beauty Salon."
      />
      {/* Add a specific wrapper or styling if needed to match the previous gallery header feel, 
             ...
             */}
      <div style={{ paddingTop: '100px', background: '#050505', minHeight: '100vh' }}>
        <Portfolio />
      </div>
    </motion.div>
  );
