...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const whatsappNumber = "919841428097";
        const text = `Hi, I'm ${formState.name} (Phone: ${formState.phone}). I would like to inquire: ${formState.message}`;
    ...
    return (
        ...
        >
            <section className="section-padding" style={{ paddingTop: '150px', background: '#000000', minHeight: '100vh' }}>
                <div className="container">
                    ...
                    <div className="contact-grid">
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                                    <div style={{ background: 'rgba(212, 175, 55, 0.1)', padding: '1rem', borderRadius: '8px' }}>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem' }}>
                                    ...
                                    <a href="https://wa.me/919841428097" target="_blank" rel="noopener noreferrer" style={{ background: 'rgba(212, 175, 55, 0.1)', padding: '0.8rem', borderRadius: '50%', color: 'var(--color-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.3s' }}>
                        ...
                        <motion.div
                            ...
                            style={{ background: '#0A0A0A', padding: '3rem', borderRadius: '12px' }}
                        >
                            ...
                            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        style={{ width: '100%', padding: '1rem', background: '#000000', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px', color: '#fff', fontSize: '1rem' }}
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        required
                                        rows="5"
                                        style={{ width: '100%', padding: '1rem', background: '#000000', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px', color: '#fff', fontSize: '1rem', resize: 'vertical' }}
