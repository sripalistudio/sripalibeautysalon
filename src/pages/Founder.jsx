...
const Founder = () => {
    ...
    const timelineEvents = [
        ...
        { year: '2025', title: 'Sripali Beauty Salon (Mar 13)', desc: 'Launched a new branch "Sripali Beauty Salon" in Sharma Nagar, marking a significant milestone after navigating the challenges of the pandemic.' },
    ...
    return (
        ...
        >
            <SEO
                ...
                description="Lalitha.S is an experienced bridal makeup artist with a journey spanning over two decades. Learn about her story from freelance artist to salon owner."
            />
            {/* Hero Section */}
            <section className="section-padding" style={{ paddingTop: '150px', background: '#000000' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '5rem', alignItems: 'center' }}>
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
                                <span style={{ background: 'rgba(212, 175, 55, 0.15)', color: 'var(--color-gold)', padding: '0.4rem 1rem', borderRadius: '50px', fontSize: '0.8rem', fontWeight: 600 }}>20+ Years Experience</span>
                                <span style={{ background: 'rgba(212, 175, 55, 0.15)', color: 'var(--color-gold)', padding: '0.4rem 1rem', borderRadius: '50px', fontSize: '0.8rem', fontWeight: 600 }}>300+ Brides</span>
                                <span style={{ background: 'rgba(212, 175, 55, 0.15)', color: 'var(--color-gold)', padding: '0.4rem 1rem', borderRadius: '50px', fontSize: '0.8rem', fontWeight: 600 }}>Educator & Mentor</span>
                            </div>
            ...
            <section className="section-padding" style={{ background: '#0A0A0A' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        ...
                        <p style={{ color: 'var(--color-text-secondary)' }}>The core values that define our salon.</p>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
                        {philosophyItems.map((item, index) => (
                            <motion.div
                                ...
                                style={{ background: '#000000', padding: '2rem', borderRadius: '8px', borderTop: '2px solid var(--color-gold)' }}
                            >
            ...
            <section className="section-padding" style={{ background: '#000000' }}>
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        {/* Vertical Line */}
                        <div style={{ position: 'absolute', left: '20px', top: 0, bottom: 0, width: '2px', background: 'rgba(212, 175, 55, 0.3)' }}></div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem' }}>
                            {timelineEvents.map((event, index) => (
                                ...
                                >
                                    {/* Dot */}
                                    <div style={{ flexShrink: 0, width: '40px', height: '40px', borderRadius: '50%', background: '#000000', border: '2px solid var(--color-gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1, position: 'relative' }}>
            ...
            {/* CTA Section */}
            <section className="section-padding" style={{ background: '#0A0A0A', textAlign: 'center' }}>
                <div className="container">
                    <motion.div
